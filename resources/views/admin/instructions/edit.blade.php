...
<head>
    ...
    <title>Edytuj instrukcję — TicketSystem</title>
...
<div class="layout">
    ...
    <main class="main">
        <div class="admin-topbar"><h2>Edytuj instrukcję</h2></div>
                ...
                <div class="box-body">
                    <form action="{{ route('admin.instructions.update', $instruction->id) }}" method="POST">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="title" placeholder="np. Procedura zwrotu płatności" value="{{ old('title', $instruction->title) }}" required maxlength="200">
                        </div>

                        <div class="field">
                            <label class="f-label">Treść instrukcji</label>
                            <textarea name="content" rows="12" placeholder="Opisz procedurę, zasady, dane techniczne lub cokolwiek, co AI powinno wiedzieć, odpowiadając klientom w tym temacie..." required maxlength="10000">{{ old('content', $instruction->content) }}</textarea>
                        </div>

                        <div class="checkbox-row">
                            <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $instruction->is_active) ? 'checked' : '' }}>
